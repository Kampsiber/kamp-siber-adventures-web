    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center space-x-1 text-sunset">
            ...
            <span className="ml-2 text-background font-medium">4.9/5 Bewertung</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-background/90 max-w-2xl mx-auto leading-relaxed">
            Erleben Sie die perfekte Mischung aus Abenteuer und Komfort am unberührten Flussufer. 
            Vom traditionellen Camping bis hin zu luxuriösem Glamping bieten wir unvergessliche Outdoor-Erlebnisse.
          </p>

          {/* Location */}
          <div className="flex items-center justify-center space-x-2 text-background/80">
            <MapPin className="h-5 w-5" />
            <span className="font-medium mx-[5px] px-[2px] my-0 py-0 text-base">Tolmin • Soča-Tal</span>
          </div>
          ...
          <div className="pt-8">
            <a href="#camping" className="inline-flex flex-col items-center text-background/70 hover:text-background transition-smooth">
              <span className="text-sm font-medium mb-2">Mehr Entdecken</span>
      ...
      <div className="absolute bottom-8 left-8 right-8 z-10">
        <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
          {[
            { number: "100+", label: "Glückliche Camper" },
            { number: "15", label: "Plätze am Fluss" },
            { number: "5", label: "Glamping Häuser" },
            { number: "bis 22h", label: "Bar Service" }
          ].map((stat, index) => (
