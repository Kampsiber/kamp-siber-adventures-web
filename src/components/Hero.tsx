  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-6">
          ...
          {/* Subtitle */}
          <p className="text-lg sm:text-xl text-background/90 max-w-2xl mx-auto leading-relaxed">Experience the perfect blend of adventure and comfort along the pristine riverside of Tolmin. From traditional camping to luxury glamping, we offer unforgettable outdoor experiences.</p>
